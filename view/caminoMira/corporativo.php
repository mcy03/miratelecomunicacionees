...
<head>
    ...
    <title>Mira | Marco corporativo</title>
</head>
<body>
    <section class="banner-principal">
        <div class="title-page">
            <h1>Marco corporativo</h1>
        </div>
    </section>
    <section class="ubicacion">
        <div class="ruta-ubi">
            <a class="ruta-page" href="<?=url?>">Home / </a><a class="ruta-page" href="<?=url.'?controller=mira'?>">Mira / </a><p class="page">Marco corporativo</p>
        </div>
    </section>
    <div class="page-content grid">
        <div class="buttons">
            <a href="<?=url.'?controller=mira&action=politica_calidad'?>">Política de Calidad - Misión, visión y valores</a>
        </div>
        ...
        <div class="text-content col-12">
            ...
            <p>
                ...
                desafíos y buenas prácticas relacionados con el uso de las herramientas digitales aplicando nuestro Protocolo de desconexión digital.
            </p>
        </div>
